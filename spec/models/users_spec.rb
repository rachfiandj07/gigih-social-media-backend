...
describe Users do
    before :each do
        @stub_client = double()
        @users = Users.new(user_id: 1, username: '@naufalrdj', bio: 'Hello', email: 'test@gmail.com', createdAt: '2021-08-15 00:51:03', updatedAt: '2021-08-15 00:51:03')
        @response = {
            "user_id" => 1,
            "username" => "naufalrdj",
            "bio" => "Hello",
    ...
    describe 'valid?' do
        ...
        context 'given invalid params' do
            it 'should return false when username is nil' do
                users = Users.new(user_id: 1, username: nil, bio: 'Hello', email: 'test@gmail.com', createdAt: '2021-08-15 00:51:03', updatedAt: '2021-08-15 00:51:03')

                expect(users.valid?).to eq(false)
            end
            it 'should return false when bio is nil' do
                users = Users.new(user_id: 1, username: '@naufalrdj', bio: nil, email: 'test@gmail.com', createdAt: '2021-08-15 00:51:03', updatedAt: '2021-08-15 00:51:03')

                expect(users.valid?).to eq(false)
            end
            it 'should return false when email is nil' do
                users = Users.new(user_id: 1, username: '@naufalrdj', bio: 'Hello', email: nil, createdAt: '2021-08-15 00:51:03', updatedAt: '2021-08-15 00:51:03')
